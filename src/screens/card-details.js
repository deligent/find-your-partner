    ...
    render() {
        return (
            <Container>
                ...
                <Left><Icon name="ios-arrow-back-outline" onPress={() => this.props.navigation.goBack()} /></Left>
                    <Body>
                ...
                <Content>
                    <List>
                        {this.state.matched ?
                            <ListItem avatar>
                                <Left>
                                    <Thumbnail source={{ uri: 'https://lh3.googleusercontent.com/iZM2K3kEL987OZXjfzxxO6fuvAjYBHamLUrP4kxPydNcfImxEjmFh38mh8wEM2pIsbkX=s180' }} />
                                </Left>
                                <Body>
